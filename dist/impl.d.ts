...
export declare const getFunctions: (axiosInstance: AxiosInstance) => {
    user: {
        userCourse(args: t.UserCourseArgs): Promise<import("axios").AxiosResponse<any, any>>;
    ...
    course: {
        deleteCourse(args: t.DeleteCourseArgs): Promise<import("axios").AxiosResponse<any, any>>;
    ...
    resolution: {
        ...
        deleteResolution(args: t.DeleteResolutionArgs): Promise<import("axios").AxiosResponse<any, any>>;
    };
    categories: {
        ...
        deleteCategory(args: t.DeleteCategoryArgs): Promise<import("axios").AxiosResponse<any, any>>;
    };
    activities: {
        ...
        deleteActivity(args: t.DeleteActivityArgs): Promise<import("axios").AxiosResponse<any, any>>;
    };
    department: {
        ...
        deleteDepartament(args: t.DeleteDepartamentArgs): Promise<import("axios").AxiosResponse<any, any>>;
    };
    student: {
        deleteActivityStudent(args: t.DeleteActivityStudentArgs): Promise<import("axios").AxiosResponse<any, any>>;
